...
![GitHub Copilot agent mode in VS Code connecting to Dremio Agentic Lakehouse via MCP](/assets/images/aitoolblogs/06/copilot-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/aitoolblogs/06/four-integration-approaches.png)
