...
tags:
  ...
  - Data Engineering
  - Deletion Vectors
slug: "equality-deletes-iceberg-v4"
draft: false
---
...
If this piece was useful, I have written a lot more on Apache Iceberg internals and lakehouse architecture. _Apache Iceberg: The Definitive Guide_, which I co-authored for O'Reilly, covers the delete file mechanics, snapshot model, and compaction strategies behind everything in this article in full detail. _Architecting an Apache Iceberg Lakehouse_ from Manning takes the same material up a level into platform design decisions. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
