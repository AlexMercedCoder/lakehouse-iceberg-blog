...
_Apache Iceberg: The Definitive Guide_ (O'Reilly) covers the metadata layers, the maintenance procedures, and the file layout behavior described here in full detail, including the tuning decisions that determine how much maintenance a table needs in the first place.
