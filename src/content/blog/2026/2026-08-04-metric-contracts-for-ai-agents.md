...
tags:
  ...
  - Apache Ossie
  - Data Governance
slug: "metric-contracts-for-ai-agents"
draft: false
---
...
If this piece was useful, I have written a lot more on semantic layers, catalogs, and the platforms underneath them. _Apache Polaris: The Definitive Guide_ covers the catalog and governance model this design registers into, and _Architecting an Apache Iceberg Lakehouse_ covers the wider platform. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
