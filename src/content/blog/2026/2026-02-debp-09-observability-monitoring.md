...
date: "2026-02-18"
description: 'An analyst messages you on Slack - "The revenue numbers look wrong. Is the pipeline broken?" You check the orchestrator - all green.'
author: "Alex Merced"
...
![Three pillars: metrics tracking counts and timing, logs recording execution details, lineage mapping data flow](/assets/images/debp/09/three-pillars.png)
...
![Alert severity levels: critical triggers pages, warning goes to channel, info logged](/assets/images/debp/09/alert-levels.png)
