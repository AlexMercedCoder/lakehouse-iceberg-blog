...
![OpenCode TUI connecting to Dremio Agentic Lakehouse via MCP](/assets/images/aitoolblogs/10/opencode-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/aitoolblogs/10/four-integration-approaches.png)
