...
![Five key components of a semantic layer connected to a central hub](/assets/images/semantic_layer/01/sl-components.png)
...
![Without vs. with a semantic layer — from metric chaos to alignment](/assets/images/semantic_layer/01/without-vs-with.png)
