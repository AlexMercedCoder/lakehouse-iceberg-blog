...
tags:
  ...
  - Data Architecture
  - Semantic Layer
slug: "five-layer-agentic-lakehouse"
draft: false
---
...
If this piece was useful, I have written a lot more on lakehouse architecture and the semantic layer. _Architecting an Apache Iceberg Lakehouse_ from Manning covers data product design, semantic modeling, and platform layering as architectural decisions. _Apache Polaris: The Definitive Guide_, which I co-authored for O'Reilly, covers the catalog's role in governing all of it across engines. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
