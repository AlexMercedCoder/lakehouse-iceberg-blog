...
tags:
  ...
  - partition pruning
  - data distribution
slug: 2026-04-29-query-engine-08
draft: false
---
...
This is Part 8 of a 10-part series on query engine design. [Part 7](/posts/2026-04-29-query-engine-07/) covered memory management. This article covers how engines divide data across files, disks, or cluster nodes to enable parallel processing and reduce the amount of data each query must touch.
...
![Hash, range, and list partitioning strategies showing how the same data is distributed differently](/assets/images/2026/query-engine-optimization/partition-types.png)
...
![Partition pruning showing 5 of 6 monthly partitions skipped when filtering by March](/assets/images/2026/query-engine-optimization/partition-pruning.png)
...
![The data skew problem showing one partition with 10x more data creating a straggler node](/assets/images/2026/query-engine-optimization/data-skew-problem.png)
