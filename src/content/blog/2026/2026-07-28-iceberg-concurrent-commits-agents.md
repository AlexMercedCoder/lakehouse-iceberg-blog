...
tags:
  ...
  - Data Engineering
  - AI Agents
slug: "iceberg-concurrent-commits-agents"
draft: false
---
...
If this piece was useful, I have written a lot more on Iceberg internals and lakehouse operations. _Apache Iceberg: The Definitive Guide_, which I co-authored for O'Reilly, covers the snapshot model, commit protocol, and maintenance operations behind everything here. _Architecting an Apache Iceberg Lakehouse_ from Manning takes the same material into platform design, including how to structure writers across a large estate. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
