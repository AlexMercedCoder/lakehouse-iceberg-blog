...
slug: "iceberg-v3-variant-shredding-s3-tables"
draft: false
---
...
If this piece was useful, I have written a lot more on Apache Iceberg and lakehouse architecture. _Apache Iceberg: The Definitive Guide_ covers the specification, the metadata layers, and the operational practices behind tables like the ones described here, and _Architecting an Apache Iceberg Lakehouse_ works through the surrounding platform decisions. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
