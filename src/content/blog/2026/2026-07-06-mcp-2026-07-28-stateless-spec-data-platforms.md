...
description: "The date in this topic matters. Today is July 6, 2026. A release candidate dated July 28, 2026 is still in the future. That means this article should not..."
author: "Alex Merced"
...
draft: false
canonicalURL: https://datalakehousehub.com/posts/mcp-2026-07-28-stateless-spec-data-platforms/
---
...
![Papercut MCP host, client, stateless server pool, and lakehouse resources architecture](/assets/images/2026/week-2026-07-06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-1.png)
...
![Papercut tool call lifecycle with identity, consent, policy, query, result, and audit](/assets/images/2026/week-2026-07-06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-2.png)
...
![Papercut Agentic Lakehouse stack with MCP interface layer above governed tools, semantic layer, query, catalog, Iceberg tables, and storage](/assets/images/2026/week-2026-07-06/mcp-2026-07-28-stateless-spec-data-platforms-diagram-3.png)
