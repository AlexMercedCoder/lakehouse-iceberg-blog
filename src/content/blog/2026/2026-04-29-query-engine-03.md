...
tags:
  ...
  - predicate pushdown
slug: 2026-04-29-query-engine-03
draft: false
---
...
This is Part 3 of a 10-part series on query engine design. [Part 2](/posts/2026-04-29-query-engine-02/) covered row vs. column storage layouts. This article goes one level deeper: how data is physically structured within files, and what metadata accompanies it to make reads efficient.
...
![The write speed vs read efficiency spectrum showing heap files, LSM trees, B-trees, and sorted files](/assets/images/2026/query-engine-optimization/write-read-spectrum.png)
...
![Anatomy of a Parquet file showing row groups, column chunks, pages, and the footer with schema and statistics](/assets/images/2026/query-engine-optimization/parquet-file-anatomy.png)
...
![How min/max statistics allow the engine to skip irrelevant row groups when filtering by price](/assets/images/2026/query-engine-optimization/predicate-pushdown-min-max.png)
