...
tags:
  ...
  - Java
  - Library Migration
slug: "iceberg-jackson-3-migration"
draft: false
---
...
If this piece was useful, I have written a lot more on Apache Iceberg internals and the ecosystem around it. _Apache Iceberg: The Definitive Guide_, which I co-authored for O'Reilly, covers the metadata structures these parsers exist to read and write. _Architecting an Apache Iceberg Lakehouse_ from Manning covers building on Iceberg's libraries as a platform decision, including where to put your own abstraction boundaries. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
