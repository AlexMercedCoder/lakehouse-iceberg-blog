...
tags:
  ...
  - Data Governance
  - Human-in-the-Loop
slug: "agent-guardrails-human-in-the-loop"
draft: false
---
...
If this piece was useful, I have written a lot more on lakehouse architecture and governance. _Apache Polaris: The Definitive Guide_, which I co-authored for O'Reilly, covers the access control model that most of these controls sit on. _Architecting an Apache Iceberg Lakehouse_ from Manning covers branching, validation, and staged promotion patterns as platform design. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
