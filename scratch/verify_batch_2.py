...
files = [
    "src/content/iceberg/dremio-metadata-caching.md",
    "src/content/iceberg/dremio-external-queries.md",
    "src/content/iceberg/dremio-user-defined-functions-udfs.md",
    "src/content/iceberg/dremio-parquet-vectorized-reader.md",
    "src/content/iceberg/dremio-iceberg-metadata-sync.md",
    "src/content/iceberg/dremio-sql-runner.md",
    "src/content/iceberg/dremio-row-level-security-rls.md",
    "src/content/iceberg/dremio-column-level-masking.md",
    "src/content/iceberg/dremio-acceleration-engine.md",
    "src/content/iceberg/dremio-join-co-segmentation.md"
]
