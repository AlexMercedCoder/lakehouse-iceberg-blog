...
If this piece was useful, I have written a lot more on catalogs and lakehouse architecture. _Apache Polaris: The Definitive Guide_, which I co-authored for O'Reilly, covers the RBAC model, credential vending, and federation mechanics that everything in this article depends on. _Apache Iceberg: The Definitive Guide_ goes deeper on the table format underneath. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
