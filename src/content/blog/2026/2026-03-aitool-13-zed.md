...
![Zed code editor AI assistant connecting to Dremio Agentic Lakehouse via MCP](/assets/images/aitoolblogs/13/zed-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/aitoolblogs/13/four-integration-approaches.png)
