...
![Claude Code connecting to Dremio Agentic Lakehouse via MCP](/assets/images/aitoolblogs/02/claude-code-dremio-mcp-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/assets/images/aitoolblogs/02/four-integration-approaches.png)
