...
In the next post, we’ll look at how to use **Iceberg’s metadata tables** to dynamically determine _when_ optimization is needed - so you can make it event-driven instead of fixed-schedule.
