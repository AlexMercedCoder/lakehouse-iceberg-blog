...
tags:
  ...
  - data storage layout
slug: 2026-04-29-query-engine-02
draft: false
---
...
This is Part 2 of a 10-part series on query engine design. [Part 1 (Overview)](/posts/2026-04-29-query-engine-01/) introduced the nine decisions every engine must make. This article covers the first and most fundamental: how bytes are arranged on disk.
...
![How the same 5 records look in row-oriented layout versus column-oriented layout on disk](/assets/images/2026/query-engine-optimization/row-vs-column-layout.png)
...
![I/O comparison showing row store reading 100 GB versus column store reading only 4 GB for the same analytical query](/assets/images/2026/query-engine-optimization/io-comparison-row-vs-column.png)
...
![Storage format choices across real systems from row-oriented PostgreSQL to column-oriented DuckDB, ClickHouse, Snowflake, and Dremio](/assets/images/2026/query-engine-optimization/storage-format-spectrum.png)
