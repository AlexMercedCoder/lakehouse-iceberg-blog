...
tags:
  ...
  - Apache Ossie
  - Apache Polaris
slug: "mcp-governed-semantic-layer"
draft: false
---
  ...
  "tools": [
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          "domain": {
            "type": "string",
            "description": "Optional business domain filter, e.g. 'sales'"
          }
        }
      }
    },
...
If this piece was useful, I have written a lot more on catalogs, semantic layers, and agentic data architecture. _Apache Polaris: The Definitive Guide_ covers the catalog and governance layer this design depends on, and _Architecting an Apache Iceberg Lakehouse_ covers the platform underneath. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
