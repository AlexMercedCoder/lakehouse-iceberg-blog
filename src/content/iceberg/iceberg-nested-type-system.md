...
description: "The set of structural data types - structs, lists, and maps - defined by the Iceberg specification that use unique field IDs to manage complex data."
