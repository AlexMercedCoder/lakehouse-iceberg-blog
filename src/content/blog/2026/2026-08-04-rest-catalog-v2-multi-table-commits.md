...
tags:
  ...
  - Catalog
  - Data Lakehouse
slug: "rest-catalog-v2-multi-table-commits"
draft: false
---
...
If this piece was useful, I have written a lot more on catalogs and lakehouse architecture. _Apache Polaris: The Definitive Guide_ covers the REST protocol, credential vending, and catalog governance in depth, and _Apache Iceberg: The Definitive Guide_ covers the table format underneath it. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
