...
pubDatetime: 2026-07-13T09:00:00Z
...
tags:
  ...
  - AI Agents
  - Metrics
slug: "semantic-view-autopilot-dynamic-metric-definition-governance"
---
...
The critical framing, though, is that everything in that list is a _proposal_. A column description is a hypothesis about meaning. A candidate metric is a guess about intent. View SQL is a suggestion about how tables relate. None of it is authoritative until a human who knows the business confirms it. The model is a fast, tireless drafter, not an oracle.
