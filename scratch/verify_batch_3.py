...
files = [
    "src/content/iceberg/dremio-engine-auto-scaling.md",
    "src/content/iceberg/dremio-ldap-integration.md",
    "src/content/iceberg/dremio-coordinator-node.md",
    "src/content/iceberg/iceberg-manifest-entry-schema.md",
    "src/content/iceberg/iceberg-manifest-list-schema.md",
    "src/content/iceberg/iceberg-table-metadata-schema.md",
    "src/content/iceberg/iceberg-nested-type-system.md",
    "src/content/iceberg/iceberg-identity-partition-transform.md",
    "src/content/iceberg/iceberg-bucket-partition-transform.md",
    "src/content/iceberg/iceberg-truncate-partition-transform.md"
]
