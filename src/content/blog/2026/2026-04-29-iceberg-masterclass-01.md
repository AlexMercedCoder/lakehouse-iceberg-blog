...
tags:
  ...
  - Apache Hudi
  - Apache Paimon
slug: 2026-04-29-iceberg-masterclass-01
draft: false
---
...
This is Part 1 of a 15-part [Apache Iceberg Masterclass](/posts/2026-04-29-iceberg-masterclass-01/). This article covers the fundamental question: what problem do table formats solve, and why does the choice between them matter?
...
![How table formats solved the chaos of raw data lakes with a structured metadata layer](/assets/images/2026/apache-iceberg-masterclass/before-after-table-formats.png)
...
![Timeline showing the evolution from Hive Metastore through Hudi, Iceberg, Delta Lake, Paimon, and DuckLake](/assets/images/2026/apache-iceberg-masterclass/format-evolution-timeline.png)
...
![Positioning chart showing where Iceberg, Delta Lake, Hudi, Paimon, and DuckLake sit on batch vs streaming and single vs multi-engine axes](/assets/images/2026/apache-iceberg-masterclass/format-positioning-chart.png)
...
The rest of this series focuses on Iceberg because its design decisions and capabilities represent the state of the art for multi-engine analytical lakehouses. [Part 2](/posts/2026-04-29-iceberg-masterclass-02/) examines the metadata structures of all five formats in detail.
