...
date: "2026-04-29"
description: "B-trees balance reads and writes for OLTP. LSM trees maximize write throughput. Bitmap indexes accelerate OLAP filtering. Here is when to use each."
author: "Alex Merced"
...
slug: 2026-04-29-query-engine-04
draft: false
---
...
This is Part 4 of a 10-part series on query engine design. [Part 3](/posts/2026-04-29-query-engine-03/) covered how data is structured within files. This article covers the auxiliary data structures that make lookups fast: indexes.
...
![B-tree structure showing root, internal, and leaf nodes with point lookup and range scan paths](/assets/images/2026/query-engine-optimization/btree-structure.png)
...
![LSM tree write path from memtable through WAL flush to SSTables across multiple levels with compaction](/assets/images/2026/query-engine-optimization/lsm-tree-write-path.png)
...
![Index type tradeoff matrix comparing read speed, write cost, memory cost, and best use case for B-trees, LSM trees, bitmap indexes, bloom filters, and zone maps](/assets/images/2026/query-engine-optimization/index-tradeoff-matrix.png)
