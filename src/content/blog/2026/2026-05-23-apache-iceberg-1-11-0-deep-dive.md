...
author: "Alex Merced"
tags:
  ["Apache Iceberg", "Data Lakehouse", "Open Table Format", "Spark", "Flink"]
category: "Data Engineering"
slug: 2026-05-23-apache-iceberg-1-11-0-deep-dive
draft: false
faqs:
  - question: "What are the most important features in Apache Iceberg 1.11.0?"
    answer: "The most critical features in Apache Iceberg 1.11.0 include manifest list encryption using the GCM stream cipher, the new pluggable File Format API that decouples Iceberg from specific storage formats, scheduled credential lifecycle refresh for S3 and GCS, and the stabilization of V3 format features including deletion vectors and the Variant type."
  - question: "How does Apache Iceberg 1.11.0 improve security?"
...
canonicalURL: "https://datalakehousehub.com/blog/2026-05-apache-iceberg-1-11-0-deep-dive/"
---
...
![Apache Iceberg 1.11.0 release overview diagram showing Security, Catalog, Storage, and Engine pillars](/assets/images/2026/iceberg-1-11-0/release-pillar-overview.png)
...
![Manifest list encryption sequence showing key exchange and decryption query planning](/assets/images/2026/iceberg-1-11-0/manifest-list-encryption-flow.png)
...
![Pluggable File Format API architecture decoupling Iceberg core from format plugins](/assets/images/2026/iceberg-1-11-0/v4-manifest-foundations.png)
...
![Extended header propagation between Iceberg client and REST Catalog server](/assets/images/2026/iceberg-1-11-0/rest-client-headers.png)
...
![Flowchart of table registration verifying catalog overwrite state and rejecting transaction on conflicts](/assets/images/2026/iceberg-1-11-0/overwrite-aware-registration.png)
...
![Sequence flow showing background thread updating AWS/GCS storage client credentials before expiration](/assets/images/2026/iceberg-1-11-0/credential-refresh-thread.png)
...
![Comparison of continuous micro-batch streaming vs Spark AvailableNow trigger batches](/assets/images/2026/iceberg-1-11-0/spark-streaming-available-now.png)
...
![Flink data sink writing data and executing post-commit branch compaction on experimental branch](/assets/images/2026/iceberg-1-11-0/flink-maintenance-branch-support.png)
