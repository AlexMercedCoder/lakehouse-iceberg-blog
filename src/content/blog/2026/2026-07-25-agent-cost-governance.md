...
_Architecting an Apache Iceberg Lakehouse_ (Manning) covers the catalog, governance, and semantic layers that make agent access to enterprise data both affordable and correct.
