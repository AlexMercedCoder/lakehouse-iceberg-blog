...
tags:
  ...
  - Token Budgets
  - Apache Iceberg
slug: "agentic-analytics-tco-token-budgets"
draft: false
---
...
If this piece was useful, I have written a lot more on agentic architecture and lakehouse economics. _Architecting an Apache Iceberg Lakehouse_ covers the table design and maintenance practices that drive the query-side costs discussed here, and _Apache Polaris: The Definitive Guide_ covers the identity and catalog layer that makes per-principal attribution possible. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
