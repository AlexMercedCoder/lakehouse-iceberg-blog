...
tags:
  ...
  - Parquet
  - Data Lakehouse
slug: "warehouse-to-iceberg-migration-playbook"
draft: false
---
...
If this piece was useful, I have written a lot more on lakehouse architecture and migration. _Architecting an Apache Iceberg Lakehouse_ covers migration strategy, table design, and the platform decisions around a move like this, and _Apache Iceberg: The Definitive Guide_ covers the conversion procedures and table mechanics in depth. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
