...
slug: 2026-04-29-query-engine-06
draft: false
---
...
This is Part 6 of a 10-part series on query engine design. [Part 5](/posts/2026-04-29-query-engine-05/) covered how optimizers pick a plan. This article covers what happens next: how the engine actually processes data through the operators in that plan.
...
![Volcano iterator model showing operators passing one tuple at a time via Next calls](/assets/images/2026/query-engine-optimization/volcano-iterator-model.png)
...
![Vectorized execution processing batches of 1024 rows with SIMD-friendly tight loops](/assets/images/2026/query-engine-optimization/vectorized-batch-model.png)
...
![Three execution models compared: Volcano for simplicity, Vectorized for CPU efficiency, Code Generation for maximum performance](/assets/images/2026/query-engine-optimization/execution-model-comparison.png)
