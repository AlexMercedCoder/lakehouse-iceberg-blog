...
_Architecting an Apache Iceberg Lakehouse_ (Manning) covers the storage, catalog, and maintenance decisions behind everything described here in far more depth, including the ingestion patterns and table layout choices that determine whether a lakehouse stays fast.
