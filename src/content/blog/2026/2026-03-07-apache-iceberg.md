...
date: "2026-03-07"
description: "If you drop ten thousand Parquet files into an S3 bucket, you have a data swamp. You do not have a database. To run SQL queries against those files sa..."
author: "Alex Merced"
...
![The Iceberg Metadata Tree showing the path from Catalog down to Data Files](/assets/images/2026/apache-lakehouse/iceberg-metadata-tree.png)
...
![Diagram showing Schema Evolution mapping unique column IDs to file structures over time](/assets/images/2026/apache-lakehouse/iceberg-schema-evolution.png)
