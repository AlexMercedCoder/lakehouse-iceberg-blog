...
tags:
  ...
  - Data Engineering
  - On-Premises
slug: "air-gapped-iceberg-lakehouse"
draft: false
---
...
If this piece was useful, I have written a lot more on lakehouse architecture and catalogs. _Architecting an Apache Iceberg Lakehouse_ from Manning covers deployment topology, storage selection, and maintenance planning as platform decisions, including on-premises considerations. _Apache Polaris: The Definitive Guide_, which I co-authored for O'Reilly, covers self-hosting the catalog, its RBAC model, and credential vending in detail. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
