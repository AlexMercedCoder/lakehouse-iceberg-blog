...
tags:
  ...
  - Data Federation
  - Lakehouse
slug: "oracle-lakehouse-federation"
draft: false
---
...
If this piece was useful, I have written a lot more on lakehouse architecture and catalogs. _Architecting an Apache Iceberg Lakehouse_ from Manning covers federation, semantic layers, and migration sequencing as platform decisions. _Apache Polaris: The Definitive Guide_, which I co-authored for O'Reilly, covers catalog federation and the governance model spanning multiple sources. You can find every book I have written, across lakehouse architecture, Apache Iceberg, Apache Polaris, and AI, at [books.alexmerced.com](https://books.alexmerced.com).
