...
date: "2026-03-07"
description: "If you ask a data analyst to calculate the average transaction amount for the month of July using a massive CSV file, the compute engine must read eve..."
author: "Alex Merced"
...
![Diagram showing Row-Based vs Column-Based physical storage on disk](/assets/images/2026/apache-lakehouse/row-vs-columnar-storage.png)
...
![Diagram of Dictionary Encoding mapping text strings to small integer identifiers](/assets/images/2026/apache-lakehouse/parquet-dictionary-encoding.png)
