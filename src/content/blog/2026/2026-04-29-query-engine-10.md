...
slug: 2026-04-29-query-engine-10
draft: false
---
...
This is Part 10 of a 10-part series on query engine design. [Part 9](/posts/2026-04-29-query-engine-09/) covered distributed joins. This final article covers how engines handle the inevitable conflict when multiple users read and write the same data simultaneously.
...
![Two-Phase Locking versus MVCC showing how locking blocks readers while MVCC allows concurrent access](/assets/images/2026/query-engine-optimization/locking-vs-mvcc.png)
...
![MVCC version chain showing three versions of the same row with different transactions seeing different versions](/assets/images/2026/query-engine-optimization/mvcc-version-chain.png)
...
![Isolation level spectrum from Read Uncommitted (weakest, fastest) to Serializable (strongest, slowest)](/assets/images/2026/query-engine-optimization/isolation-levels.png)
